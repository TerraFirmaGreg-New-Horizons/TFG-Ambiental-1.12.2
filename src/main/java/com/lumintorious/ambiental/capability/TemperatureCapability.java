...
public class TemperatureCapability implements ICapabilitySerializable<NBTTagCompound> {
	...
	public static final ResourceLocation KEY = new ResourceLocation(MODID, "temperature");
	...
	public float getChange() {
		...
		float speed = getPotency() * 0.025f * TFCAmbientalConfig.GENERAL.temperatureChangeSpeed;
